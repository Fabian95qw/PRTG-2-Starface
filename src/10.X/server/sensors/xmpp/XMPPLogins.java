...
@Function(visibility=Visibility.Private, description="Returns the amount of total and unique XMPP Users")
public class XMPPLogins implements IBaseExecutable 
{
	...
	{
		ServerBusinessObject SBO = context.springApplicationContext().getBean(ServerBusinessObject.class);
