...
import de.starface.integration.uci.ucp.adapters.v30.requests.UcpQueueRequestsAdapter;
...
public class IQueueStats implements IBaseExecutable
{
	...
	public void execute(IRuntimeEnvironment context) throws Exception
	{
		...
		UcpQueueRequestsAdapter UQA = context.springApplicationContext().getBean(UcpQueueRequestsAdapter.class);
		FastAgiHandler FAGI = context.springApplicationContext().getBean(FastAgiHandler.class);
