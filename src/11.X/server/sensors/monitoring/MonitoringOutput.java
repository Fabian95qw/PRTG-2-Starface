...
@Function(visibility=Visibility.Private, description="Returns Monitoring Output")
public class MonitoringOutput implements IBaseExecutable 
{
	...
	{
		MonitoringComponent MC = (MonitoringComponent)context.springApplicationContext().getBean(MonitoringComponent.class);
